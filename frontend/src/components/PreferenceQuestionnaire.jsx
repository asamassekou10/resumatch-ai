    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-slate-800 border border-slate-700 rounded-2xl max-w-xl w-full p-6 shadow-2xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="text-center mb-4">
          <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full mb-2">
          ...
          {[1, 2, 3, 4].map(s => (
            <div
              ...
              className={`h-1.5 flex-1 rounded-full transition-colors ${
                s <= step ? 'bg-gradient-to-r from-cyan-500 to-purple-600' : 'bg-slate-700'
              }`}
            />
          ))}
        </div>
        ...
        <div className="flex justify-between mt-5 pt-4 border-t border-slate-700">
          ...
          <div>
            {step < 4 ? (
              <button
                onClick={nextStep}
                className="px-5 py-2 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 text-white rounded-lg font-medium transition text-sm"
              >
                Continue
              </button>
            ) : (
              <button
                ...
                disabled={loading}
                className="px-5 py-2 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 text-white rounded-lg font-medium transition flex items-center gap-2 text-sm"
              >
                {loading ? (
                  <>
